...
|---------------|------------|----|-----------|----------|-------|-------|
| polire/custom/custom.py:38:8 | `self.reg.fit(X, y)` | unknown / unknown | unknown / unknown | polymorphic_library_receiver | manual_reasoned | v: self.reg can be an xgboost or sklearn regressor depending on the constructor arg |
| polire/custom/custom.py:53:15 | `self.reg.predict(np.asarray([X1.ravel(), X2.ravel()]).T)` | unknown / unknown | unknown / unknown | polymorphic_library_receiver | manual_reasoned | v: self.reg can be an xgboost or sklearn regressor depending on the constructor arg |
| polire/custom/custom.py:59:15 | `self.reg.predict(X)` | unknown / unknown | unknown / unknown | polymorphic_library_receiver | manual_reasoned | v: self.reg can be an xgboost or sklearn regressor depending on the constructor arg |
