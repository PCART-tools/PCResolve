# tensorflow1 — static_obvious (9 records)
...
| tf_decorator.py:8:8 | `super().__init__(**kwargs)` | python / python | python / python | builtin | static_obvious | v: Python builtin function or method call |
...
| tf_decorator.py:18:17 | `super().get_config()` | python / python | python / python | builtin | static_obvious | v: Python builtin function or method call |
| tf_decorator.py:19:8 | `config.update({'units': self.units})` | python / python | python / python | builtin | static_obvious | v: Python builtin function or method call |
