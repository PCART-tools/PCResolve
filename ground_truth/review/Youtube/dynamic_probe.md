...
|---------------|------------|----|-----------|----------|-------|-------|
| Kmeans.py:27:14 | `centres.todense()` | library / scipy | library / scipy | transitive_method | dynamic_probe | gt: scipy sparse .todense()<br>v: probe confirms .todense() __module__ is scipy.sparse._base; scipy sparse method. |
