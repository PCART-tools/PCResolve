...
| allnews_am/wikiextractor/WikiExtractor.py:2920:16 | `input.close()` | unknown / unknown | unknown / unknown | branch_dependent_io_receiver | manual_reasoned | v: input can be sys.stdin or fileinput.FileInput depending on input_file |
| allnews_am/wikiextractor/WikiExtractor.py:2985:4 | `input.close()` | unknown / unknown | unknown / unknown | branch_dependent_io_receiver | manual_reasoned | v: input can be sys.stdin or fileinput.FileInput depending on input_file |
| allnews_am/wikiextractor/WikiExtractor.py:3078:12 | `output.write(spool.pop(next_page).encode('utf-8'))` | unknown / unknown | unknown / unknown | branch_dependent_io_receiver | manual_reasoned | v: output can be a project-local OutputSplitter or a Python stdout buffer |
| allnews_am/wikiextractor/WikiExtractor.py:3103:8 | `output.close()` | unknown / unknown | unknown / unknown | branch_dependent_io_receiver | manual_reasoned | v: output can be a project-local OutputSplitter or a Python stdout buffer |
...
| allnews_am/wikiextractor/cirrus-extract.py:165:15 | `input.readline()` | unknown / unknown | unknown / unknown | branch_dependent_io_receiver | manual_reasoned | v: input can be sys.stdin or gzip.open output |
| allnews_am/wikiextractor/cirrus-extract.py:169:29 | `input.readline()` | unknown / unknown | unknown / unknown | branch_dependent_io_receiver | manual_reasoned | v: input can be sys.stdin or gzip.open output |
| allnews_am/wikiextractor/cirrus-extract.py:183:12 | `output.write(page.encode('utf-8'))` | unknown / unknown | unknown / unknown | branch_dependent_io_receiver | manual_reasoned | v: file-like receiver depends on the runtime output branch |
