...
|---------------|------------|----|-----------|----------|-------|-------|
| sci.py:23:10 | `uarr.dot(sarr)` | library / numpy | library / scipy | transitive_method | dynamic_probe | gt: NumPy ndarray dot method<br>v: type(uarr) is numpy.ndarray and uarr.dot.__self__ is uarr |
| sci.py:23:10 | `uarr.dot(sarr).dot(vharr)` | library / numpy | library / scipy | transitive_method | dynamic_probe | gt: NumPy ndarray dot method after ndarray return<br>v: the intermediate result is numpy.ndarray and abc.dot.__self__ is abc |
