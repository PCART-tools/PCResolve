...
| myregr.py:16:11 | `res.dot(res)` | library / numpy | unknown / unknown | transitive_method | dynamic_probe | v: runtime probe: receiver type is numpy.ndarray; dot is bound and its descriptor o |
...
| myregr.py:24:17 | `dif.dot(xp)` | library / numpy | unknown / unknown | transitive_method | dynamic_probe | v: runtime probe: receiver type is numpy.ndarray; dot is bound and its descriptor o |
