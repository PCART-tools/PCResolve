...
| myregr.py:37:8 | `s.append(c.x)` | python / python | local / local | builtin_method_local_receiver | dynamic_probe | v: runtime probe: receiver type is builtins.list; append is bound and its descripto |
...
| skregr.py:14:8 | `s.append(model.coef_)` | python / python | local / local | builtin_method_local_receiver | dynamic_probe | v: runtime probe: receiver type is builtins.list; append is bound and its descripto |
