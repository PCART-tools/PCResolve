...
|---|---:|---:|---|
| `UNRESOLVED` | 217 | 87.9% | The analyzer preserves uncertainty at a receiver, return, attribute, item, or call edge. |
| `LOCAL_DEFINITION` | 20 | 8.1% | A local binding is selected although the reviewed runtime callable has another owner. |
